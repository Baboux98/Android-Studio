...
//import android.annotation.SuppressLdouble;
    ...
    /*public  void Cliquer (View view) {
        ...
        switch (value) {
            ...
            case "+":
                ...
                Anciennevalue = (String) screen.getText();
                operator = "+";
                break;
            case "*":
                ReadyForNewInput = true;
            ...
            case "-":
                ...
                break;
            default:
                if (ReadyForNewInput == false) {
                    screen.setText(screen.getText() + value);
                }else if (ReadyForNewInput==true){
                    screen.setText(" " + value);
